...
customer_df = spark.read.option("header", True).csv("/mnt/data/Customer.csv")
product_df = spark.read.option("header", True).csv("/mnt/data/Product.csv")
sales_df = spark.read.option("header", True).csv("/mnt/data/Sales.csv")
